...
n    if(sort==='newest') list.sort((a,b)=>b.year-a.year)
...
n      <div className="mt-6 grid grid-cols-1 md:grid-cols-4 gap-6">
...
n          <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
